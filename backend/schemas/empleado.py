...
class CreateEmpleado(BaseModel):
    ...
    tiene_password : bool = False  # ← nuevo
    permite_huella   : bool = True
    permite_rfid     : bool = True
    permite_password : bool = True  # ← nuevo
    activo : bool = True
...
class ResponseEmpleado(BaseModel):
    ...
    tiene_huella   : bool
    tiene_password : bool  # ← nuevo
    permite_huella : bool
    permite_rfid   : bool
    permite_password : bool  # ← nuevo
    activo    : bool
    creado_en : datetime
...
class UpdateEmpleado(BaseModel):
    ...
    tiene_password : Optional[bool] = None  # ← nuevo
    permite_huella   : Optional[bool] = None
    permite_rfid     : Optional[bool] = None
    permite_password : Optional[bool] = None  # ← nuevo
